...
<div class="container">
    <div class="breadcrumb breadcrumb-wrap">
        <ul itemscope itemtype="http://schema.org/BreadcrumbList">
            ...
            <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                <a title="FAQ" itemprop="item" href="javascript:void(0)" class="current">
    ...
    <div class="container">
        <div class="row">
            <div class="md-12">
                ...
                <meta itemprop="mainEntityOfPage" content="<?php echo $base_url; ?>" />
